    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height:90%; background-color:#F0F0F0;">
                    ...
                    @endphp
                        <div id="kvadrat" @if($stream->Live()) style="font-color: red;" @endif @if($event->sport == 'ufc')  title="{{ $event->team1 }} ON Channel #{{ $stream->id }}" style="vertical-align: top;" @endif @if($event->sport == 'nhl') style="border-left:5px solid black; border-top:5px solid black; border-right:5px solid black; border-bottom:5px solid black; "@endif>
